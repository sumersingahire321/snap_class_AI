...
from src.components.dialog_shere_subject import share_subject_dialog
...
from src.database.pipelines.face_pipelines import predict_attendance
from src.database.db import get_attendance_for_teacher, create_attendance
...
def teacher_dashboard():
    ...
    if st.session_state.current_teacher_tab == "attendance_records":
        teacher_tab_attendance_recoads()
...
def teacher_tab_attendance_recoads():
